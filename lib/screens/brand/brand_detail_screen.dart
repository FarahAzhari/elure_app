...
class BrandDetailScreen extends StatefulWidget {
  ...
  final String brandName; // The name of the brand to display
...
class _BrandDetailScreenState extends State<BrandDetailScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              // Grid of products for the selected brand
              Padding(
  ...
  // Custom AppBar for the Brand Detail Screen
    ...
    return AppBar(
      ...
      leading: IconButton(
        ...
        onPressed: () {
          Navigator.pop(
            context,
          ); // Go back to the previous screen (BrandScreen)
        },
      ),
      title: Text(
    ...
    if (_filteredProducts.isEmpty) {
      ...
      return GridView.builder(
        ...
        gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
          ...
          childAspectRatio:
              0.65, // Adjusted aspect ratio to make cards taller for stacked price display
        ),
